...
class ContractorAccountCreator:
    ...
    async def create_auth_user(self, contractor_data):
        ...
        try:
            ...
            if result.data:
                ...
                print(f"✅ Auth profile created: {user_id}")
                print(f"   Login Email: {email}")
                print(f"   Password: {password}")
                return user_id, email, password
            else:
                print("❌ Failed to create auth profile")
        ...
        try:
            ...
            if profile_result.data:
                ...
                if contractor_result.data:
                    ...
                    print(f"✅ Contractor details found: {contractor['company_name']}")
                    return True, contractor
                else:
                    print("❌ Contractor details not found")
                    return False, None
            else:
    ...
    async def create_sample_project_history(self, contractor_id):
        ...
        try:
            ...
            print("✅ Sample project history created")
            return True
            
        except Exception as e:
            print(f"❌ Error creating project history: {str(e)}")
            return False

async def main():
    """Create a complete test contractor account"""
    print("🏗️  Creating Test Contractor Account")
    print("=" * 50)
    ...
    print("\n" + "=" * 50)
    print("🎯 TEST CONTRACTOR ACCOUNT CREATED!")
    print("=" * 50)
    print(f"📧 Login Email: {email}")
    print(f"🔑 Password: {password}")
    print(f"🏢 Company: {contractor_data['company_name']}")
