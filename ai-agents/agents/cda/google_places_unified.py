...
class GooglePlacesOptimized:
    ...
    def _format_contractor(self, place: Dict[str, Any]) -> Dict[str, Any]:
        ...
        rating_value = place.get("rating", 0)
        review_count = place.get("userRatingCount", 0)
        
        return {
            "place_id": place.get("id", ""),
            "google_place_id": place.get("id", ""),  # Add google_place_id
            "name": place.get("displayName", {}).get("text", ""),
            ...
            "google_rating": rating_value,  # Add expected field name
            "google_review_count": review_count,  # Add expected field name
            "google_maps_uri": place.get("googleMapsUri", ""),
            "google_maps_url": place.get("googleMapsUri", ""),  # Add alias
            "business_status": place.get("businessStatus", ""),
            "google_business_status": place.get("businessStatus", ""),  # Add expected field
