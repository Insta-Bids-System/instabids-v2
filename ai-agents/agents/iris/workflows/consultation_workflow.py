...
class ConsultationWorkflow:
    """Handles design consultation conversations and workflow progression"""
    ...
    def __init__(self):
        ...
        self.consultation_phases = {
            'discovery': 'Understanding user needs and preferences',
            'exploration': 'Exploring design options and styles',
            'refinement': 'Narrowing down choices and details',
            'planning': 'Creating actionable project plans',
            'handoff': 'Ready for contractor consultation'
        }
    ...
    def process_consultation(
        ...
        """
        Process design consultation conversation
    ...
    def _generate_consultation_response(
        ...
        if current_phase == 'discovery':
            response_text = self._generate_discovery_response(request, conversation_intent)
    ...
    def _generate_discovery_response(self, request: UnifiedChatRequest, intent: Dict[str, Any]) -> str:
